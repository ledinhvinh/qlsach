                    ...
                    <div class="container-fluid">
                        <div class="card shadow mb-4">
                            ...
                            <div class="form-group col-md-4">
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="searchnh" id="searchnh"
                                                    required placeholder="Tìm kiếm Nhập Nguồn Hàng" autofocus>
                                            </div>
                                    ...
                                    <table class="table table-bordered" id="formtable">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT phieunhaphang.*, phieunhaphang.id as idpnh ,nhacungcap.* FROM `phieunhaphang`
                                             INNER JOIN nhacungcap on phieunhaphang.id_nhacungcap = nhacungcap.id ORDER BY `phieunhaphang`.`id` ASC";
                                            ...
                                            if (mysqli_num_rows($result) > 0) {
                                                while ($row = mysqli_fetch_array($result)) {
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <td><?php echo $row['idpnh']?></td>
                                                        <td><?php echo $row['name']?></td>
                                                        <td><?php echo $row['namesach']?></td>
                                                        <td><?php echo $row['soluong']?></td>
                                                        <td><?php echo $row['gianhap']?></td>
                                                        <td><?php echo $row['thanhtien']?></td>
                                                        <td><?php echo $row['date']?></td>
                                                        
                                                        <td id="action"><a href="suanhaphang.php?idpnh=<?php echo $row['idpnh']?>" class="btn btn-secondary">Sửa</a>
                                                            <a onclick="return confirm('Xác Nhận Xóa ?')" href="../controller/xoaphieunhaphang.php?idpnh=<?php echo $row['idpnh']?>" class="btn btn-danger">Xóa</a>
                                                            <a href="../controller/nhaphang.php?idpnh=<?php echo $row['idpnh']?>" class="btn btn-primary">Nhập Hàng</a>
                                                        </td>
                                                        <td>
                                                            
                                                            <a href="indonhang.php?iddh=<?php echo $row['idpnh']?>" class="btn btn-success">In Đơn</a>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                }
           ...
           <script src="js/demo/chart-area-demo.js"></script>
            ...
            <script>
                $(document).ready(function(){
                    $("#searchnh").keyup(function(){
                        var search = $("#searchnh").val();
                        
                        $.ajax({
                            url:'xulysearchnh.php',
                            method:'post',
                            data:{searchnh : search},
