            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        $iddh = $_GET['iddh'];
                        // echo $iddh;
                        $sql = "SELECT phieunhaphang.*, nhacungcap.* FROM phieunhaphang INNER JOIN nhacungcap on phieunhaphang.id_nhacungcap = nhacungcap.id 
                        WHERE phieunhaphang.id = $iddh";
                        ...
                        inphieunhaphang($iddh, $tenncc, $diachi, $sdt, $email, $mota, $namesach, $soluong, $gianhap, $giaban, $thanhtien, $tacgia, $date);
                        ?>
                        
                        <div class="text-center">
                        <iframe width="900" height="700" src="./resource/inphieunhap<?php echo $iddh?>.pdf" frameborder="0"></iframe>
                    </div>
