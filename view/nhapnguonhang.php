            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <form action="../controller/xulynhapnguonhang.php" method="POST" id="orderForm">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card shadow mb-4">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input type="number" class="form-control" readonly name="thanhtien" id="thanhtien" >
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-3">
                                ...
                                <div class="col-md-12">
                                    <div class="card shadow mb-4">
                                        ...
                                        <div class="form-group col-md-3">
                                            <input type="submit" class="btn btn-primary" name="nhapnguonhang"
                                                value="Nhập Nguồn Hàng">
                                        </div>
                                    </div>
                                </div>
