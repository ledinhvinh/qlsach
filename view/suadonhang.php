                ...
                <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <div id="content">
                        ...
                        <div class="container-fluid">
                            <form action="../controller/suadonhang.php" method="POST" id="orderForm">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card shadow mb-4">
                                            <div class="card-header py-3">
                                                ...
                                                $sql = "SELECT hoadon.*,hoadon.id as iddh , hoadon.soluong as soluongdatmua ,hoadon.gia as tongtien, khachhang.*, khachhang.name as namekh ,sach.*, sach.name as namesach , sach.gia as pricebook ,nhomkhachhang.* FROM hoadon INNER JOIN khachhang ON hoadon.id_kh = khachhang.id 
                                                INNER JOIN sach ON hoadon.id_sach = sach.id INNER JOIN nhomkhachhang on khachhang.id_nhomkh = nhomkhachhang.id 
                                                WHERE hoadon.id = $id GROUP by hoadon.id";
                                            ...
                                            <input type="hidden" class="form-control" readonly name="iddh" value="<?php echo $row['iddh'] ?>">
                                            <input type="hidden" class="form-control" readonly name="idkh" value="<?php echo $row['id_kh'] ?>">
                                            <input type="hidden" class="form-control" readonly name="idsach" value="<?php echo $row['id_sach'] ?>">
                                            <div class="form-group">
                                                <div class="form-group col-md-12">
                                                    <label for="">Tên Khách Hàng</label>
                                                    <input type="text" class="form-control" readonly name="tenkh"
                                                        value="<?php echo $row['namekh'] ?>">
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card shadow mb-4">
                                            ...
                                            <div id="formdata">
                                                <div class="form-group">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <input class="form-control" readonly id="tensach" value="<?php echo $row['namesach']?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <input class="form-control" readonly id="giaban" value="<?php echo $row['giaban']?>">
                                            ...
                                            <div class="form-group">
                                                <div class="form-group col-md-12">
                                                    <label for="">Số Lượng Đặt Mua</label>
                                                    <input type="number" name="soluong" class="form-control" min="1"
                                                        id="soluong" value="<?php echo $row['soluongdatmua']?>">
                                                </div>
                                            </div>
                                            
                                            <div class="form-group col-md-12">
                                                <label for="">Tổng tiền</label>
                                                <input readonly class="form-control" name="gia" id="finalprice" value="<?php echo $row['tongtien']?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="card shadow mb-4">
                                            ...
                                            <div class="form-group">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input type="date" name="date" id="date" class="form-control" min="" max="" required value="<?php echo $row['date']?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group col-md-3">
                                                <input type="submit" class="btn btn-primary" name="capnhapdonhang"
                                                    value="Cập Nhập Đơn Hàng">
                                            </div>
