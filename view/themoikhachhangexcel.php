            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <form action="../controller/nhapexcelkh.php" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-header d-flex justify-content-between">
                                            <h6 class="m-0 font-weight-bold text-primary">Chọn file excel Khách Hàng</h6>
                                            <a href="resource/nhapexcelkh.xlsx">File Excel Mẫu Khách Hàng</a>
                                        </div>
                                        <div class="card-body">
