            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        $iddh = $_GET['iddh'];
                        // echo $iddh;
                        $sql = "SELECT DATE_FORMAT(hoadon.date, '%d-%m-%Y') as date1, hoadon.*, sach.*, khachhang.*, khachhang.name as namekh, sach.name as namesach, hoadon.soluong as slhd, hoadon.gia as tthd, nhomkhachhang.sale FROM hoadon INNER JOIN khachhang ON hoadon.id_kh = khachhang.id INNER JOIN sach ON hoadon.id_sach = sach.id INNER JOIN nhomkhachhang on khachhang.id_nhomkh = nhomkhachhang.id
                        WHERE hoadon.id = $iddh";
                        ...
                        indonhang($iddh, $namekh, $sdt, $email, $diachi, $theloaikh, $namesach, $soluong, $giaban, $thanhtien, $ngaydat, $description);
                        ?>
                        
                        <div class="text-center">
                        <iframe width="900" height="700" src="./resource/indonhang<?php echo $iddh?>.pdf" frameborder="0"></iframe>
                    </div>
                    <?php 
                    ?>
                    </div>
